...
class FisherMatrix:
    ...
    def compute_fisher_matrix(
        ...
        logger.info(f"Computing Fisher matrix for {n_params} parameters...")
    ...
    def marginalize_parameters(
        ...
        Marginalization integrates over nuisance parameters, producing marginal
        constraints on the remaining parameters. This is done by:
        1. Converting Fisher matrix to covariance matrix (inverse)
        2. Extracting covariance submatrix for parameters of interest
        3. Converting back to Fisher matrix (inverse of submatrix)

        This differs from conditioning, which fixes parameters at specific values.
        ...
        Notes
        -----
        Marginal constraints are always weaker (larger errors) than conditional
        constraints, reflecting the additional uncertainty from integrating over
        nuisance parameters.
        """
