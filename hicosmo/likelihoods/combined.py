...
class CombinedLikelihood(Likelihood):
    ...
    def _setup_shared_grid(self):
        ...
        # Build unified low-z grid: take the densest sub-likelihood's grid size.
        # Grid density directly affects gradient precision via AD, which impacts
        # NUTS sampling efficiency (tau). 2048 points causes tau degradation at d>=4;
