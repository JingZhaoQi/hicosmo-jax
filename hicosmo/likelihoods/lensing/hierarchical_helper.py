...
class HierarchicalGWLikelihood:
    ...
    @classmethod
    def from_raw(cls, events_data: Dict[str, Dict[str, Any]], injections_data: Dict[str, Any], **kwargs):
    ...
    def log_likelihood_traced(self, cosmo_params: Dict[str, Any], **kwargs):
        if not hasattr(self._like, 'log_likelihood_traced'):
            raise AttributeError('Underlying likelihood does not support traced evaluations.')
