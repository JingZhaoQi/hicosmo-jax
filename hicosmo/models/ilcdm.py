...
class ILCDM(LCDM):
    ...
    def __init__(self,
        ...
        super().__init__(H0=H0, Omega_m=Omega_m, Omega_b=Omega_b,
                         Omega_k=0.0, beta=beta, **kwargs)
...
def planck2018_ilcdm(beta: float = 0.0, **kwargs) -> ILCDM:
    ...
    defaults = {'H0': 67.36, 'Omega_m': 0.3153, 'Omega_b': 0.0493,
                'sigma8': 0.8111, 'n_s': 0.9649, 'beta': beta}
